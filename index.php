...
<head>
    ...
    <title>bitfunded - for serios crypto trader</title>
...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        <div class="flex justify-between">
            <a href="/" class="flex items-center p-2 mr-4 no-underline">
                <img class="max-h-l4 w-auto" style="box-shadow: 10px 10px 5px lightblue inset;" src="img/logo.png" />
            </a>
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            <a href="#home" class="fs-m1 mx-3 py-3 indigo no-underline fw-700 hover-underline">Wie es funktioniert</a>
            <a href="#features" class="fs-m1 mx-3 py-3 indigo no-underline fw-700 hover-underline">FAQ</a>
            <a href="#pricing" class="fs-m1 mx-3 py-3 indigo no-underline fw-700 hover-underline">Trading</a>
            <a href="#blog" class="fs-m1 mx-3 py-3 indigo no-underline fw-700 hover-underline">Contact</a>
            <a href="app" class="button bg-white black fw-600 no-underline mx-5">Kundenbereich</a>
        </div>
    </nav>
    <!-- hero section -->
    <section id="home" class="min-h-100vh flex justify-start items-center">
        ...
        <div class="mx-5 md-mx-l5">
        <img src="img/main_pic.jpg" alt="main-picture">
        </div>
    </section>
            ...
            <div class="w-100pc md-w-75pc">
                <div class="p-5">
                    ...
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">
                        ...
                        <li class="p-5">Die Verifikation und das Bestehen der Challenge sind wichtig, um sicherzustellen, dass Trader, 
    ...
    <footer class="p-5 md-p-l5 bg-indigo-lightest-10">
        <div class="flex flex-wrap">
            <div class="md-w-25pc mb-10 md-px-10">
                <img src="img/logo.png" class="w-xl1" alt="bitfunded logo">
            ...
            <div class="w-100pc md-w-50pc">
                <div class="flex justify-around">
                    <div class="w-33pc md-px-10 mb-10">
                        ...
                        <ul class="list-none mt-5 fs-s2">
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Evaluierungsprozess</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Handelsziele</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Warum bitfunded Challenge?</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Kapitalerhöhungsplan</a>
                            </li>
                        </ul>
                    </div>
                    <div class="w-33pc md-px-10 mb-10">
                        ...
                        <ul class="list-none mt-5 fs-s2">
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Partner</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Jobs</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">AGB</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Datenschutz</a></li>
                        </ul>
                    </div>
                </div>
            </div>
